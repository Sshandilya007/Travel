$(".switch input[type='checkbox']").click(function(){
    ...
    if($(this).is(":checked")){
      localStorage.setItem("setmode",1)
        $("#lightcss").attr("href",'css/light.css');
    }else{
         localStorage.setItem("setmode",2)
      $("#lightcss").attr("href",'');
    }
})
if( localStorage.getItem("setmode")==1){
  ...
  $("#location-input").click(function(){
    ...
    $(".bottom-sheet-location  ").css("bottom","72px");
    $(".overlay-body").css("display","block");
  });

  $("#location-output").click(function(){
  ...
  $(".close-btn ").click(function(){
    ...
    $(".bottom-sheet-location  ").css("bottom","-100%");
    $(".overlay-body").css("display","none");
  });

  $("#passenge-bottomsheet").click(function(){
    
    $("#room-bs").css("bottom","65px");
    $(".overlay-body").css("display","block");
  });
  
  $(".close-btn ").click(function(){
    
    $("#room-bs").css("bottom","-100%");
    $(".overlay-body").css("display","none");
  });
